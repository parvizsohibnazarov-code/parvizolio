...
placeholder content — `Parviz Sohibnazarov`, a generic hero image, and so on.
...
> "Parviz Sohibnazarov." Update the LinkedIn and GitHub links in index.html's social
> box to my profiles: <your LinkedIn URL> and <your GitHub URL>.

Things to personalize:

- [ ] Your name, replacing `Parviz Sohibnazarov` everywhere it appears.
- [ ] Your own header/banner image, replacing `images/iron-man-tony-stark.jpg`.
